        ...
        <div className="">
            ...
            <footer className="footer px-6 lg:px-24 bg-gray-900 text-gray-200 p-10">
                <nav>
                    ...
                    <a className="link link-hover">Specialty Beans</a>
                    <a className="link link-hover">Cold Brew Selection</a>
                    <a className="link link-hover">Espresso Machines</a>
                </nav>
                <nav>
                    <h6 className="footer-title text-lg text-white">About Us</h6>
                    <a className="link link-hover">Our Story</a>
                    <a className="link link-hover">Meet Our Baristas</a>
                    <a className="link link-hover">Sustainability</a>
                    <a className="link link-hover">Careers</a>
                </nav>
                <nav>
                    <h6 className="footer-title text-lg text-white">Customer Care</h6>
            ...
            <footer className="footer px-6 lg:px-24 bg-gray-800 text-gray-300 border-t border-gray-700 py-4">
                <aside className="grid-flow-col items-center">
                    ...
                    <p>
                        Finest Coffee Selection, Brewed to Perfection.
                        <br />
                        © {new Date().getFullYear()} Espresso Premium. All rights reserved.
                    </p>
                </aside>
